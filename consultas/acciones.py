...
class Acciones:
    ...
    def crear(self, usuario):
        ...
        motivo = input("Escribe motivo de la consulta: ")
        descripcion = input("Describe los sintomas: ")

        consulta = modelo.Consulta(usuario[0], paciente,motivo, descripcion)
    ...
    def mostrar(self, usuario):
        ...
        for consulta in consultas:
            ...
            print("Motivo de la consulta: ",consulta[3])
    ...
    def editar(self, usuario):
        ...
        motivo = input("Introdude el diagnostico: ")
        descripcion = input("Describa el diagnostico: ")
       

        consulta = modelo.Consulta(usuario[0])
        modificar = consulta.editar(paciente,motivo,descripcion,id)
